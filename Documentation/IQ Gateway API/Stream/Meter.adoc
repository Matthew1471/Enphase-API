...
However in newer versions such as D7.6.175, Enphase restricted this to only tokens of the "Installer" type, "Owner" tokens would result in an access denied error.
