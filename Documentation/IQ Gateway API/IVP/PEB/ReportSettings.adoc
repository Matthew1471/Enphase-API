= IVP - Power Electronics Blocks (PEB) - Report Settings
:toc: preamble
...
|Object
|Object
|The Enphase(R) Cloud (formerly "Enlighten Cloud") report settings. This is actually a JSON object but treated as form data.
