...
Get Enphase(R) Energy System (formerly "Ensemble") CAN device (3rd-Generation, such as IQ System Controller 3 or IQ Battery 5P) status. Enphase(R) call the CAN bus the "Controller wire".
