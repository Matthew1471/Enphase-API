                ...
                if chunk_first_received:
                    ...
                    if chunk_first_received + 10 < now:
                        ...
                        while not queued_chunks.empty():
                            ...
                            #print(str(timestamp) + ' - ' + str(json_object['net-consumption']['ph-a']['p']) + ' W', flush=True)

                            # The queue has no reliable method for determining queue size.
                            counter+=1

                        # Print statistics.
                        print(str(datetime.datetime.now()) + ' - Length:' + str(stats_length) + ',Count:' + str(stats_count) + ',Min:' + str(stats_min) + ',Max:' + str(stats_max) + ',Latency:' + str(chunk_delay), flush=True)
